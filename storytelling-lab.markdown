...
<div class="container p-y-2">
	<div class="row color-dark-blue">
		...
		<div class="col-xs-12 col-md-5 col-lg-5 col-md-offset-1 col-lg-offset-1 m-b-3">
			...
			<p class="small-body">Taught by amazing authors and illustrators in the Brooklyn community and beyond, our Stories Master Classes introduce young writers and artists to the world of the professional writer and offer a chance to learn directly from expert practitioners of the art form.</p>				<p class="small-body">Our Master Classes are usually 1.5-hour sessions held on a weekday evening or weekend, and focus on some element of storytelling of the master author or artist's choosing.</p>
			<a href="{{ site.url }}/registration" class="btn btn-primary-outline">Sign Up</a>
		</div>
	</div>
	<div class="row color-dark-blue">
